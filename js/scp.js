...
function getCannedResponse(idx,fObj)
{
    ...
    Http.get({
        url: ajaxurlloc+"api=kbase&f=cannedResp&id="+idx,
...
function toggleMessage(id) {
    ...
    if(document.getElementById(msgId).className == 'hide'){
        ...
        document.getElementById(imgId).src=ajaxurl+'images/minus.gif';
    }else {
        document.getElementById(msgId).className='hide';
        document.getElementById(imgId).src=ajaxurl+'images/plus.gif';
    }
}
